...
export default function Login() {
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface min-h-screen flex items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-primary-fixed/30 via-surface to-surface">
      <div className="w-full max-w-md bg-white rounded-[24px] shadow-xl p-8 border border-white/50 ai-glow relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h1 className="font-headline-md text-headline-md mt-4">Welcome back</h1>
          <p className="text-on-surface-variant mt-2 font-body-md">Enter your details to access your dashboard.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          ...
          <div className="space-y-1">
            ...
            <div className="flex justify-end mt-1">
              <Link to="/login" className="text-primary font-label-md hover:underline">Forgot password?</Link>
            </div>
          </div>

          <button type="submit" className="w-full py-3 bg-primary text-on-primary rounded-xl font-headline-md text-label-md hover:opacity-90 active:scale-95 transition-all shadow-md">
            Log in
          </button>
        </form>
